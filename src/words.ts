...
export const allFieldTypes: ReadonlyArray<FieldType> = [
  'agric', 'anat', 'archeol', 'archit', 'art', 'astron', 'aviat', 'baseb',
  'biochem', 'biol', 'bot', 'Buddh', 'bus', 'chem', 'Christn', 'comp',
  'cryst', 'ecol', 'econ', 'elec', 'electr', 'embryo', 'engr', 'ent', 'finc',
  'fish', 'food', 'gardn', 'genet', 'geogr', 'geol', 'geom', 'go', 'golf',
  'gramm', 'grmyth', 'hanaf', 'horse', 'law', 'ling', 'logic', 'MA', 'mahj',
  'math', 'mech', 'med', 'met', 'mil', 'music', 'paleo', 'pathol', 'pharm',
  'phil', 'photo', 'physics', 'physiol', 'print', 'psych', 'Shinto', 'shogi',
  'sports', 'stat', 'sumo', 'telec', 'tradem', 'zool'
];
